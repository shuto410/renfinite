...
describe('effects', () => {
  describe('applyBlockEffect', () => {
    describe('3x3 board', () => {
      ...
      describe('all direction', () => {
        test('should return all 8 surrounding positions when in center', () => {
          ...
          expect(result).toEqual(expect.arrayContaining([1, 0, 2, 7, 6, 8, 3, 5]));
        });
    ...
    describe('5x5 board', () => {
      ...
      test('should handle larger board correctly for all directions', () => {
        ...
        expect(allResult).toEqual(expect.arrayContaining([7, 6, 8, 17, 16, 18, 11, 13]));
      });
    });
    ...
    describe('edge cases', () => {
      test('should handle 1x1 board', () => {
        ...
        expect(applyBlockEffect(0, 'all', 1)).toEqual([]);
      });
  ...
  describe('getValidBlockDirections', () => {
    ...
    test('should return all directions for center position', () => {
      ...
      expect(result).toEqual(expect.arrayContaining(['up', 'right', 'down', 'left']));
    ...
    test('should return only valid directions for corner position', () => {
      ...
      expect(result).toEqual(expect.arrayContaining(['right', 'down']));
    ...
    test('should return only valid directions for edge position', () => {
      ...
      expect(result).toEqual(expect.arrayContaining(['right', 'down', 'left']));
      expect(result).not.toContain('up');
    });
  });
  ...
  describe('applyAllDestroy', () => {
    describe('3x3 board', () => {
      ...
      test('should return all 8 surrounding positions from center', () => {
        ...
        expect(result).toEqual(expect.arrayContaining([0, 2, 6, 8, 1, 5, 3, 7]));
        expect(result).toHaveLength(8);
      });
    ...
    describe('5x5 board', () => {
      ...
      test('should return all 8 surrounding positions from center', () => {
        ...
        expect(result).toEqual(expect.arrayContaining([6, 8, 16, 18, 7, 13, 11, 17]));
        expect(result).toHaveLength(8);
      });
    });
