...
const mockCalculateWinner = calculateWinner as jest.MockedFunction<typeof calculateWinner>;
...
describe('CPU Opponent Functions', () => {
  ...
  describe('evaluateCell', () => {
    ...
    describe('center bonus calculation', () => {
      test('should give higher center bonus to center positions', () => {
        ...
        const centerResult = evaluateCell(emptySquares, emptyBlocked, 4, size, 3); // center
        const cornerResult = evaluateCell(emptySquares, emptyBlocked, 0, size, 3); // corner
      ...
      test('should calculate correct center bonus for 5x5 board', () => {
        ...
        const centerResult = evaluateCell(emptySquares, emptyBlocked, 12, size, 4); // center (2,2)
        const cornerResult = evaluateCell(emptySquares, emptyBlocked, 0, size, 4); // corner (0,0)

        expect(centerResult.centerBonus).toBeGreaterThan(cornerResult.centerBonus);
      });
    });
  });
  ...
  describe('findValidPositionsForMagic', () => {
    const squares = [null, 'X', null, 'O', null, null, null, null, null] as ('X' | 'O' | null)[];
    const blockedSquares = [null, null, 'X', null, null, null, null, null, null] as ('X' | 'O' | null)[];

    test('should find valid positions for replace magic', () => {
      const replaceMagic: Card = { ...MAGIC_CARDS.replace, id: 'replace-test' };
      
      const result = findValidPositionsForMagic(replaceMagic, squares, blockedSquares);
    ...
    test('should find valid positions for normal magic', () => {
      ...
      const result = findValidPositionsForMagic(normalMagic, squares, blockedSquares);
    ...
    test('should find valid positions for block magic', () => {
      ...
      const result = findValidPositionsForMagic(blockMagic, squares, blockedSquares);
    ...
    test('should handle empty board', () => {
      ...
      const result = findValidPositionsForMagic(normalMagic, emptySquares, emptyBlocked);
  ...
  describe('findWinningMove', () => {
    ...
    test('should find winning move with normal placement', () => {
      const squares = [null, null, null, 'O', 'O', null, null, null, null] as ('X' | 'O' | null)[];
    ...
    test('should find winning move with magic', () => {
      const squares = ['X', null, null, 'O', 'O', null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
      const replaceMagic: Card = { ...MAGIC_CARDS.replace, cost: 2, id: 'replace-test' };
      ...
      const result = findWinningMove(squares, blockedSquares, 3, 3, [replaceMagic], 3);
    ...
    test('should return null when no winning move exists', () => {
      const squares = [null, null, null, null, 'O', null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
    ...
    test('should not use magic if insufficient mana', () => {
      const squares = ['X', null, null, 'O', 'O', null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
      const expensiveMagic: Card = { ...MAGIC_CARDS.replace, cost: 5, id: 'expensive' };
      
      const result = findWinningMove(squares, blockedSquares, 3, 3, [expensiveMagic], 2);
  ...
  describe('findBlockingMove', () => {
    ...
    test('should find move to block opponent victory', () => {
      const squares = ['X', 'X', null, null, null, null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
    ...
    test('should prioritize blocking over other moves', () => {
      const squares = ['X', 'X', null, 'O', null, null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
  ...
  describe('findBestPositionForMagic', () => {
    test('should find best position for normal magic', () => {
      const squares = [null, null, null, null, null, null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
      const normalMagic: Card = { ...MAGIC_CARDS.normal, id: 'normal-test' };
      
      const result = findBestPositionForMagic(normalMagic, squares, blockedSquares, 3, 3);
    ...
    test('should handle replace magic correctly', () => {
      const squares = ['X', null, null, null, null, null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
      const replaceMagic: Card = { ...MAGIC_CARDS.replace, id: 'replace-test' };
      
      const result = findBestPositionForMagic(replaceMagic, squares, blockedSquares, 3, 3);
    ...
    test('should consider crossDestroy magic effectiveness', () => {
      const squares = [null, null, null, null, 'X', null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
      const crossDestroyMagic: Card = { ...MAGIC_CARDS.crossDestroy, id: 'cross-test' };
      
      const result = findBestPositionForMagic(crossDestroyMagic, squares, blockedSquares, 3, 3);
  ...
  describe('integration scenarios', () => {
    test('should prioritize winning over blocking', () => {
      const squares = ['X', 'X', null, 'O', 'O', null, null, null, null] as ('X' | 'O' | null)[];
      const blockedSquares = Array(9).fill(null) as ('X' | 'O' | null)[];
      ...
      const blockingMove = findBlockingMove(squares, blockedSquares, 3, 3, [], 1);
